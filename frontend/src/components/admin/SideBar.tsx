...
import restauranteIcon from "/icons/restaurante_menu.svg";
import produtoIcon from "/icons/produto_menu.svg";
import dashboardIcon from "/icons/dashboard_menu.svg";
...
const StyledWrapper = styled.div`
  ...
  .theme-switch__container::before {
    ...
    z-index: 1;
    inset: 0;
    box-shadow: inset 0 0.05em 0.187em rgba(0, 0, 0, 0.25);
    border-radius: var(--container-radius);
  }
